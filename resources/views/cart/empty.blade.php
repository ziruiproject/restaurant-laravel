...
@section('content')
    <section class="flex flex-col items-center justify-center min-h-screen">
        <svg class="" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 896 747.97143"
            ...
            <path
                ...
                transform="translate(-152 -76.01429)" fill="#ec7905" />
        ...
        <span class="pt-16 pb-4 text-3xl font-semibold">Your Cart is Empty</span>
        <a href="{{ route('food.index') }}" class="rounded-3xl bg-orange w-full py-3 text-lg font-bold text-center text-white shadow-md">
            Explore Menu
        </a>
    </section>
@endsection

            ...
            <div class="gap-y-2 flex flex-col">
                <form action="" class="gap-y-2 flex flex-col">
                    <div class="flex flex-col">
                        ...
                        <select name="dine" id="dine" class="bg-orange-shade rounded-xl focus:outline-none p-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <select name="table" id="table" class="bg-orange-shade rounded-xl focus:outline-none p-2">

    ...
    <div class="gap-y-4 flex flex-col">
        ...
        <div class="gap-y-4 flex flex-col">
                ...
                <div class="w-fit gap-x-2 flex items-center self-center justify-center">
                    <button class="min-amount">
                        <?xml version="1.0" encoding="UTF-8"?><svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" color="#C2BBBD">
                            <path d="M8 12H16" stroke="#C2BBBD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path
                    ...
                    <button class="add-amount">
                        <?xml version="1.0" encoding="UTF-8"?><svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" color="#FACC15">
            ...
            <form method="post" action="{{ route('cart.add') }}">
                ...
                <button type="submit" id="total-amount" class="rounded-2xl w-full py-4 text-lg font-bold text-center bg-yellow-400 shadow-md">
...
<script>
    ...
    function updateDisplay(){
        ...
        totalAmount.innerText = 'Tambah Pesanan - ' + (count * {{$food->price}}).toLocaleString('id-ID', {
            style: 'currency',
            currency: 'IDR',
        });;
    };
